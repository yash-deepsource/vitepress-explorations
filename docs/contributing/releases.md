...
- [Node.js release process](#nodejs-release-process)
  ...
  - [How to create a release](#how-to-create-a-release)
    ...
    - [4. Update the changelog](#4-update-the-changelog)
      - [Step 1: Collect the formatted list of changes](#step-1-collect-the-formatted-list-of-changes)
      - [Step 2: Update the appropriate doc/changelogs/CHANGELOG\_\*.md file](#step-2-update-the-appropriate-docchangelogschangelog_md-file)
      - [Step 3: Update any REPLACEME and DEP00XX tags in the docs](#step-3-update-any-replaceme-and-dep00xx-tags-in-the-docs)
  ...
  - [LTS Releases](#lts-releases)
    ...
    - [Update release labels](#update-release-labels)
  - [Major releases](#major-releases)
    - [Schedule](#schedule)
    - [Release branch](#release-branch)
    - [Create release labels](#create-release-labels)
    - [Release proposal](#release-proposal)
    - [Update `NODE_MODULE_VERSION`](#update-node_module_version)
    - [Test releases and release candidates](#test-releases-and-release-candidates)
    - [Changelogs](#changelogs)
      - [Create the changelog file](#create-the-changelog-file)
      - [Generate the changelog](#generate-the-changelog)
      - [Generate the notable changes](#generate-the-notable-changes)
    - [Update the expected assets](#update-the-expected-assets)
    - [Snap](#snap)
...
`REPLACEME` tags as per the example in the. Check for these tags with
